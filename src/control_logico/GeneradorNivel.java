...
public class GeneradorNivel {
	...
	public List<GameObject> generar(int nivel){
		...
		for(int i=0;i<nivel;i++){
			...
			oleada.add(new Stormtrooper(Constantes.VENTANA_ANCHO+(i*distancia)+auxInicio*(distancia/4)*(rnd.nextInt(3)+1)+rnd.nextInt(50), h/6));
			oleada.add(new Stormtrooper(Constantes.VENTANA_ANCHO+(i*distancia)+(distancia/4)*(rnd.nextInt(3)+1)+rnd.nextInt(50), h/3));
			oleada.add(new Stormtrooper(Constantes.VENTANA_ANCHO+(i*distancia)+(distancia/4)*(rnd.nextInt(3)+1)+rnd.nextInt(50), h/2));
			oleada.add(new Stormtrooper(Constantes.VENTANA_ANCHO+(i*distancia)+(distancia/4)*(rnd.nextInt(3)+1)+rnd.nextInt(50), 3*h/2));
